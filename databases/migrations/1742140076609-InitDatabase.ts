...
export class InitDatabase1742140076609 implements MigrationInterface {
    name = 'InitDatabase1742140076609'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "key" character varying NOT NULL, "description" text, "role_group_id" uuid, CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "password_reset_tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "token" character varying NOT NULL, "email" character varying NOT NULL, "expired_at" TIMESTAMP, "is_expired" boolean NOT NULL DEFAULT false, "verified_at" TIMESTAMP, "is_verified" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_d16bebd73e844c48bca50ff8d3d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "otps" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "code" character varying NOT NULL, "email" character varying NOT NULL, "expired_at" TIMESTAMP, "is_expired" boolean NOT NULL DEFAULT false, "verified_at" TIMESTAMP, "is_verified" boolean NOT NULL DEFAULT false, "retries" integer NOT NULL DEFAULT '1', CONSTRAINT "PK_91fef5ed60605b854a2115d2410" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "roles" ADD CONSTRAINT "FK_e605cec4fa96301076a42f1c550" FOREIGN KEY ("role_group_id") REFERENCES "role_groups"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "roles" DROP CONSTRAINT "FK_e605cec4fa96301076a42f1c550"`);
