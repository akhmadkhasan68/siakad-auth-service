...
export class VerifyUserByEmailAndPasswordResponseV1Dto {
    id?: string;
    firstName: string;
    lastName: string;
    email: string;
    ...
    static toResponseDto(data: IUser): VerifyUserByEmailAndPasswordResponseV1Dto {
        // creating the response object
        const response = new VerifyUserByEmailAndPasswordResponseV1Dto();
        response.id = data.id;
